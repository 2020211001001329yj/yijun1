<%@ page import="com.yijun.model.Product" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2>
					...
					<c:forEach var="p" items="${productList}">
						...
						<tr>
							...
							<%
								com.yijun.model.Product p = (Product) pageContext.findAttribute("p");
								int pid = Math.toIntExact(p.getProductId());
								Connection con = (Connection) application.getAttribute("con");
								String catName = com.yijun.model.Category.findByCategoryId(con,pid);
							%>
