			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.yijun.model.Order o=(com.yijun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.yijun.dao.UserDao userDao=new com.yijun.dao.UserDao();
						...
						<%
							...
							String paymentType=com.yijun.model.Payment.findByPaymentId(con,n);
							 %>
